...
class Activities(APIModel):
    ...
    hyakunin_ikki_v21: typing.Optional[OldActivity[HyakuninIkki]] = pydantic.Field(
        default=None, json_schema_extra={"gslug": "sumo"}
    )
    hyakunin_ikki_v25: typing.Optional[OldActivity[HyakuninIkki]] = pydantic.Field(
        default=None, json_schema_extra={"gslug": "sumo_second"}
    )
    labyrinth_warriors: typing.Optional[OldActivity[LabyrinthWarriors]] = pydantic.Field(
        default=None, json_schema_extra={"gslug": "rogue"}
    )
    energy_amplifier: typing.Optional[Activity[EnergyAmplifier]] = pydantic.Field(
        default=None, json_schema_extra={"gslug": "channeller_slab_copy"}
    )
    study_in_potions: typing.Optional[OldActivity[Potion]] = pydantic.Field(
        default=None, json_schema_extra={"gslug": "potion"}
    )
    summertime_odyssey: typing.Optional[Summer] = pydantic.Field(default=None, json_schema_extra={"gslug": "summer_v2"})
